## This is Language Converter Api.It converts latin to cyrillic, cyrillic to latin and also you can include your files
...
1. only POST request http://127.0.0.1:8000/api/ - endpoint to convert text
